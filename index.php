...
<head>
  ...
  <title>Celestial Chronometry & Haute Horology — Solsticewrist</title>
  <meta name="description" content="Crafted with micro-engineered mechanical calibres, sapphire crystal cases, and hand-finished guilloché dials for discerning collectors.">
  <link rel="canonical" href="https://solsticewrist.com/">
...
<body>
  ...
  <div class="announcement-bar" style="background: #080B10; color: #FAF8F5; border-bottom: 1px solid rgba(212, 175, 55, 0.3);">
    <span>&#9672; HAUTE HORLOGERIE &bull; SIDEREAL CALIBRES &bull; SALON AT 181 MERCER STREET &bull; TEL: +1-888-777-5845 &bull; CONCIERGE@SOLSTICEWRIST.COM</span>
  </div>
  <!-- Mandatory Global Site Header (Exactly 1 per page) -->
  <header class="site-header">
    <div class="header-container">
      <a href="/" class="brand-logo" aria-label="Solsticewrist Home">
        <span class="logo-mark">◈</span>
        <span class="logo-text">Solsticewrist</span>
      </a>
  ...
  <div class="mobile-drawer" id="mobile-drawer" aria-hidden="true">
    <div class="drawer-header">
      <div class="drawer-brand">Solsticewrist</div>
    ...
    <nav class="drawer-nav" aria-label="Mobile Navigation">
      ...
      <a href="/collection.html" class="drawer-link">Horological Calibre Gallery</a>
    ...
    <div class="drawer-footer">
      ...
      <p class="drawer-contact-info">Email: concierge@solsticewrist.com</p>
    </div>
  </div>
    ...
    <div class="container">
      <div style="display: grid; grid-template-columns: 1.15fr 1fr; gap: 4rem; align-items: center;">
        <div>
          ...
          <p class="lead" style="margin-bottom: 2rem; font-size: 1.18rem; line-height: 1.75;">Crafted with micro-engineered mechanical calibres, sapphire crystal cases, and hand-finished guilloché dials for discerning collectors.</p>
        ...
        <div style="position: relative;">
          <div style="border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-gold); border: 2px solid rgba(212, 175, 55, 0.6);">
            <img src="/assets/images/watch_1.jpg" alt="Solsticewrist flagship chronometer" style="width: 100%; height: auto;">
          </div>
    ...
    <div class="container">
      <div class="grid-2">
        ...
        <div style="order: 2; border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-gold); border: 1px solid var(--color-border);">
          <img src="/assets/images/watch_10.jpg" alt="Brass astrolabe and celestial navigation dial">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      <div class="section-header text-center">
        ...
        <h2>Four Architectural Pillars of Solsticewrist</h2>
      ...
      <div class="grid-4">
        <div class="pillar-card">
          ...
          <h3>High-Beat Chronometry</h3>
          <p>Operating at 28,800 vibrations per hour with silicon escapements ensuring chronometer-grade precision.</p>
        </div>
        <div class="pillar-card">
          <div class="pillar-icon">◈</div>
          <h3>Architectural Skeletonization</h3>
          <p>Hand-chamfered bridges, Côtes de Genève striping, and perlage finishing on every internal movement plate.</p>
        </div>
        <div class="pillar-card">
          <div class="pillar-icon">◈</div>
          <h3>Grand Feu Enamel & Guilloché</h3>
          <p>Traditional dial craftsmanship fired at 800 degrees Celsius for permanent chromatic depth and scratch immunity.</p>
        </div>
        <div class="pillar-card">
          <div class="pillar-icon">◈</div>
          <h3>120-Hour Power Reserve</h3>
          <p>Twin-barrel mainspring architecture providing five days of continuous autonomous chronometric amplitude.</p>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="grid-3">
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/watch_11.jpg" alt="Watch 11">
        ...
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/watch_12.jpg" alt="Watch 12">
        ...
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/watch_14.jpg" alt="Watch 14">
        ...
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/watch_15.jpg" alt="Watch 15">
        ...
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/watch_16.jpg" alt="Watch 16">
        ...
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/watch_2.jpg" alt="Watch 2">
    ...
    <div class="container">
      <div class="grid-2">
        <div>
          ...
          <h2>Horological Metallurgy & Silicon Physics</h2>
          <p>Every calibre is assembled in atmospheric cleanrooms using non-magnetic silicon hairsprings and Glucydur balance wheels that resist ambient electromagnetic interference.</p>
          <p>Cases are forged from surgical-grade 904L stainless steel and solid 18k gold, polished by hand using diamond pastes to mirror perfection.</p>
          <div class="card-specs" style="border: none; margin: 1.5rem 0;">
            <span>◈ <strong>28,800 VPH High Beat</strong></span>
            <span>◈ <strong>120-Hour Power Reserve</strong></span>
            <span>◈ <strong>300m Hydrostatic Rating</strong></span>
          </div>
        ...
        <div style="border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-gold); border: 1px solid var(--color-border);">
          <img src="/assets/images/watch_3.jpg" alt="Horological coaxial escapement and gear train assembly">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section section-light">
    <div class="container">
      <div class="grid-2">
        <div style="border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-gold); border: 1px solid var(--color-border);">
          <img src="/assets/images/watch_4.jpg" alt="Master watchmaker bench and precision micrometer testing at 181 Mercer Street">
        </div>
        <div>
        ...
        <table class="spec-table">
          <thead>
            <tr>
              ...
              <th>Solsticewrist Bespoke Standard</th>
    ...
    <div class="container">
      ...
      <div class="grid-4">
        <div class="step-card">
          ...
          <h3>Manual Winding Ritual</h3>
          <p>Wind the crown smoothly 30 turns clockwise at the same hour each morning to maintain optimal mainspring torque.</p>
        </div>
        <div class="step-card">
          <div class="step-number">02</div>
          <h3>Magnetic Field Shielding</h3>
          <p>Keep mechanical calibres at least 10cm away from laptop speakers, smartphone induction chargers, and magnetic clasps.</p>
        </div>
        <div class="step-card">
          <div class="step-number">03</div>
          <h3>Rinse After Saltwater</h3>
          <p>Rinse cases thoroughly in lukewarm fresh water after ocean swimming to dissolve abrasive marine salt micro-crystals.</p>
        </div>
        <div class="step-card">
          <div class="step-number">04</div>
          <h3>5-Year Atelier Overhaul</h3>
          <p>Return the movement to 181 Mercer Street every five years for sonic cleaning, synthetic relubrication, and gasket resealing.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      ...
      <div class="grid-3">
        <div class="card">
          <div class="card-image-wrap">
            <img src="/assets/images/watch_1.jpg" alt="Material Provenance Treatise">
        ...
        <div class="card">
          <div class="card-image-wrap">
            <img src="/assets/images/watch_10.jpg" alt="Micro-Engineering Tolerances Treatise">
        ...
        <div class="card">
          <div class="card-image-wrap">
            <img src="/assets/images/watch_11.jpg" alt="Biomechanical Ergonomics Treatise">
  ...
  <section class="section section-light">
    <div class="container">
      <div class="section-header text-center">
        ...
        <p class="text-muted" style="max-width: 650px; margin: 0.8rem auto 0;">
          Reflections from international collectors, horologists, and long-standing patrons of Solsticewrist.
        </p>
      </div>
      <div class="grid-3">
    ...
    <div class="container">
      <div class="contact-grid">
        <div class="contact-info-card">
          ...
          <div class="contact-detail-row">
            <span class="contact-icon">◈</span>
            <div><strong>Concierge Dispatch:</strong><br>concierge@solsticewrist.com</div>
          </div>
          <div class="contact-detail-row">
            <span class="contact-icon">◈</span>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-col">
          <div class="footer-brand">◈ Solsticewrist</div>
          <p class="footer-desc">
            The benchmark of master chronometry & haute horology. Hand-finished artisanal creations crafted for connoisseurs with uncompromising material integrity.
          </p>
          ...
          <div class="footer-contact-item"><strong>Concierge:</strong> concierge@solsticewrist.com</div>
        </div>
        <div class="footer-col">
      ...
      <div class="footer-bottom">
        <p>&copy; 2026 Solsticewrist Atelier. All Rights Reserved. Handcrafted at 181 Mercer Street, New York, NY 10012, United States.</p>
